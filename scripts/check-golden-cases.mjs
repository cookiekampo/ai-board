...
const markerMap = {
  ...
  opinionRequest: ["DR_PROMPT_OPINION_REQUEST", "DR_REVIEW_OPINION_REQUEST"],
  ...
  reviewOpinionRequest: "DR_REVIEW_OPINION_REQUEST",
...
const headingAliases = {
  ...
  opinionRequest: ["ChatGPTに意見をもらう用カード", "意見をもらう用カード", "Opinion Request"],
  ...
  reviewOpinionRequest: ["ChatGPTに意見をもらう用カード", "意見をもらう用カード", "Opinion Request"],
...
const exitCardAliases = {
  ...
  chatgptopinionrequest: "opinionRequest",
  chatgptcard: "opinionRequest",
  opinioncard: "opinionRequest",
  splitprompt: "split",
  一発版プロンプト: "oneShot",
  分割版プロンプト: "split",
  推奨実行順: "order",
